...
class DatabaseProvider {
  ...
  static const ROOT = "https://alleatoapis.com/apis/digriapanAPI.php";

  static Future<bool> conecctionIntent(String tempServer) async {
    Map data = {'db_host': '187.190.75.152,49940'};
    //encode Map to JSON
...
static Future<List<dynamic>> getTomasInventarios(
  ...
  // Obtener artículo
  static Future<List<dynamic>> getArticuloDigriapan(
      String articulo, int usuario) async {
    var preffs = await SharedPreferences.getInstance();
    String tempServer = preffs.getString("server") ??
        '187.190.75.152,49940'; // Si no existe, usa valor predeterminado
